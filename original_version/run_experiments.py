...
def experiment_1_speed_reducer_scbo(run_dir, n_runs=5):
    """
...
def experiment_2_speed_reducer_pca(run_dir, n_runs=5, n_components=4):
    """
...
def experiment_3_speed_reducer_kpca(run_dir, n_runs=5, n_components=4):
    """
